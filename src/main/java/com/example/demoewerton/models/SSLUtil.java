package com.example.demoewerton.models;
...
public class SSLUtil {
	...
	public static void setupSslContext() {
		...
		try {
			...
			String keyStorePath = "C://Users/artur.maschietto/Desktop/pamcary/dogtag_volpe_61139432000172.p12";

			String trustStorePath = "C://Program Files/java/jdk1.8.0_201/bin/pamcarykeystore.jks";

			String keyStorePw = "v01pE";

			String trustStorePw = "mykeystore";

			String keyPass = "v01pE";
	...
	private static SSLContext initializeSSLContext(final String keyStorePath, final String pwKeyStore,
		...
		try {
			...
			System.out.println(
					"KeyStoreException exception occurred while reading the config file : " + exp.getMessage());
